...
I am an MCA graduate with a strong foundation in software development
and web technologies. I enjoy building practical applications,
solving problems, and continuously improving my technical skills.

- 🎓 MCA Graduate from Galgotias University, Greater Noida
...
A real-time video conferencing web application designed for
peer-to-peer video and audio communication.

**Technologies:** React.js, Node.js, Express.js, WebRTC, Socket.io
...
🔗 [View Repository](https://github.com/Ranjan8294/Apna-Video-Call)

---

### 🏨 Travel Accommodation & Destination Booking

A full-stack web application for searching destinations,
applying filters, and booking travel services.

**Technologies:** Node.js, Express.js, MongoDB, Mapbox API
